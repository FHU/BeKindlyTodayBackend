...
SELECT pg_catalog.setval('public.challenge_completions_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.completion_reports_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.report_creators_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.user_completions_id_seq', 1, false);
